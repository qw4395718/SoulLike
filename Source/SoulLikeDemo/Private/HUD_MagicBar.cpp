...
#include "HUD_MagicBar.h"
#include "SoulLikeGameGlobal.h"

void UHUD_MagicBar::InitMagicBar(float Min, float Max)
{
...
void UHUD_MagicBar::ReduceMagicPercent(float ReducePercent)
{
...
void UHUD_MagicBar::ReviveMagicPercent(float RevivePercent)
{
